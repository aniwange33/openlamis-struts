...
<html>
    <head>
        ...
        <script type="text/JavaScript">
            ...
            //            $.getJSON("Pharmacy_grid.action?q=1&patientId=46712",
            //            {
            //            q: 1,
            //            patientId: 46712
            //            }, function (json) {
            ...
            colModel: [
            {name: "dateVisit", index: "date1", width: "120", formatter: "date", formatoptions: {srcformat: "m/d/Y", newformat: "d/m/Y"}},
            ...
            colModel: [
            {name: "dateVisit", index: "date1", width: "150", formatter: "date", formatoptions: {srcformat: "m/d/Y", newformat: "d/m/Y"}},
            ...
            {name: "patientId", index: "patientId", width: "260", formatter:function (cellValue, options, rowObject){
            ...
            colModel: [
            {name: "dateVisit", index: "date1", width: "180", formatter: "date", formatoptions: {srcformat: "m/d/Y", newformat: "d/m/Y"}},
            {name: "dateEac1", index: "dateEac1", width: "180", formatter: "date", formatoptions: {srcformat: "m/d/Y", newformat: "d/m/Y"}},                        
            {name: "dateEac2", index: "dateEac2", width: "180", formatter: "date", formatoptions: {srcformat: "m/d/Y", newformat: "d/m/Y"}},                        
            ...
            {name: "patientId", index: "patientId", width: "290", formatter:function (cellValue, options, rowObject){
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <section id="content1">
                                    <!-- ART Clinic -->
                                    <div class="row">
                                        <div id="accordion" role="tablist" aria-multiselectable="true" class="card-collapse col-12">
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="careheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#clinictab" aria-expanded="false" aria-controls="clinictab" class="collapsed">
                                                        Clinic Visit <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="clinictab" class="collapse" role="tabpanel" aria-labelledby="clinicheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newClinicVisit" class="btn btn-info">New</button>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group no-border col-6 pull-right">
                                                                    <input id="searchCare" type="text" class="form-control" placeholder="Search...">
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="artheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#arttab" aria-expanded="false" aria-controls="arttab" class="collapsed">
                                                ...
                                                <div id="arttab" class="collapse" role="tabpanel" aria-labelledby="artheading">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mr-auto ml-auto">
                                                                <div class="btn-group">
                                                                    <button onClick="editArt();" class="btn btn-info">New</button>
                                                                </div>
                                                                <div class="table-responsive">
                                                                    <table class="table table-striped">
                                                                        <tr>
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="supportheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#supporttab" aria-expanded="false" aria-controls="supporttab" class="collapsed">
                                                        Care and Support Assessment <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="supporttab" class="collapse" role="tabpanel" aria-labelledby="supportheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="input-group no-border col-6 pull-right">
                                                                    <input id="searchUnsuppressed" type="text" class="form-control" placeholder="Search...">
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text">
                                                                            <i class="now-ui-icons ui-1_zoom-bold"></i>
                                                                        </div>
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="cstatusheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#cstatustab" aria-expanded="false" aria-controls="cstatustab" class="collapsed">
                                                        Clinic Status Update <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="cstatustab" class="collapse" role="tabpanel" aria-labelledby="cstatusheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newUnsuppressed" class="btn btn-info">New</button>
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="unsuppressedheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#unsuppressedtab" aria-expanded="false" aria-controls="unsuppressedtab" class="collapsed">
                                                        Unsuppressed Client Monitoring/ Enhanced Adherence Counseling <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="unsuppressedtab" class="collapse" role="tabpanel" aria-labelledby="unsuppressedheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newUnsuppressed()" class="btn btn-info">New</button>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 mr-auto ml-auto">
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <div id="unsuppressedpager" style="text-align:center;"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="accordion" role="tablist" aria-multiselectable="true" class="card-collapse col-12">
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="ancheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#anctab" aria-expanded="false" aria-controls="anctab" class="collapsed">
                                                ...
                                                <div id="anctab" class="collapse" role="tabpanel" aria-labelledby="careheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="ancRegistration()" class="btn btn-info">New</button>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group no-border col-6 pull-right">
                                                                    <input id="searchUnsuppressed" type="text" class="form-control" placeholder="Search...">
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="labourheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#labourtab" aria-expanded="false" aria-controls="labourtab" class="collapsed">
                                                        Labour and Delivery <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="labourtab" class="collapse" role="tabpanel" aria-labelledby="labourheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newDelivery();" class="btn btn-info">New</button>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group no-border col-6 pull-right">
                                                                    <input id="searchUnsuppressed" type="text" class="form-control" placeholder="Search...">
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="cupdateheading">
                                                    <a data-toggle="collapse" data-parent="#accordion" href="#cupdatetab" aria-expanded="false" aria-controls="cupdatetab" class="collapsed">
                                                        ANC/PNC Visit<i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>

                                                <div id="cupdatetab" class="collapse" role="tabpanel" aria-labelledby="cupdateheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newUnsuppressed" class="btn btn-info">New</button>
                                            ...
                                            <div class="card card-plain">
                                                <div class="card-header" role="tab" id="followupheading">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#followuptab" aria-expanded="false" aria-controls="followuptab">
                                                        Child Follow-up <i class="now-ui-icons arrows-1_minimal-down"></i>
                                                    </a>
                                                </div>
                                                <div id="followuptab" class="collapse" role="tabpanel" aria-labelledby="followupheading">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <button onclick="newChildFollowup();" class="btn btn-info">New</button>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="input-group no-border col-6 pull-right">
                                                                    <input id="searchUnsuppressed" type="text" class="form-control" placeholder="Search...">
                                ...
                                <section id="content4">
                                    <div class="row">
                                        <div class="col-md-12 mr-auto ml-auto">
                                            <div class="table-responsive">
                                                <table class="pharmac" class="table table-bordered table-striped table-hover"></table>
                                            </div>
                                        </div>
                                    </div>
                                </section>
