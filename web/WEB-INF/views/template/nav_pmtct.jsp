...
<!--    <a class="navbar-brand" href="#" id="dash-label">ANC Clinic</a>-->
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown pull-right">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                    <a class="dropdown-item" href="Reporting_month_pmtct?formId=1">PMTCT Monthly Summary</a>
                    <a class="dropdown-item" href="Reporting_month_pmtct?formId=2">PMTCT Monthly Summary Addendum</a>
                    <a class="dropdown-item" href="Reporting_period_pmtct?formId=1">NIGERIA QUAL Indicators</a>
                </div>
            </li>
        </ul>
    </div>
