                            ...
                            <div class="card-body">
                                ...
                                <section id="content2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group no-border col-6 pull-right">
                                                <input id="searchOrder" type="text" class="form-control" placeholder="Search...">
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="now-ui-icons ui-1_zoom-bold"></i>
                                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <section id="content1a">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group no-border col-6 pull-right">
                                                <input id="searchSample" type="text" class="form-control" placeholder="Search...">
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="now-ui-icons ui-1_zoom-bold"></i>
                                                    </div>
                                ...
                                <section id="content2a">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group no-border col-6 pull-right">
                                                <input id="searchProcessing" type="text" class="form-control" placeholder="Search...">
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="now-ui-icons ui-1_zoom-bold"></i>
                                                    </div>
                                ...
                                <section id="content3a">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="input-group no-border col-6 pull-right">
                                                <input id="searchDispatch" type="text" class="form-control" placeholder="Search...">
                                                <div class="input-group-append">
                                                    <div class="input-group-text">
                                                        <i class="now-ui-icons ui-1_zoom-bold"></i>
                                                    </div>
