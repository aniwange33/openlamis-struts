    ...
    <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav">
            <li class="nav-item dropdown switch-locale">
                <a class="nav-link dropdown-toggle switch-locale" href="#" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false">
                    Visualizer</a>
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown09">
                    ...
                    <a class="dropdown-item" href="Htschart_page.action">HTS Chart</a>
                </div>
            </li>
        </ul>
    </div>
