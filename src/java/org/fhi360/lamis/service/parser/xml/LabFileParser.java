...
public class LabFileParser { 
    ...
    public void parseFile(String attachmentFileName) {
        executeUpdate("DROP VIEW IF EXISTS labresult"); 
        executeUpdate(" CREATE VIEW labresult (labno varchar(15), result varchar(25), date_assay date)"); 
                ...
                if (rowcount > 1 ) {
                    ...
                    if(cell != null && cell.getCellType() != Cell.CELL_TYPE_BLANK) {
                        switch(cell.getCellType()) {
                            case Cell.CELL_TYPE_STRING: labno =  cell.getStringCellValue();
                                break;
                            case Cell.CELL_TYPE_NUMERIC: labno =  Double.toString(cell.getNumericCellValue());
                                break;
                        }
                    }
                    cell = row.getCell(9);
