...
public class SyncClinicChartAction extends ActionSupport {
    ...
    public String getChartData() {
        ...
        chartUtil.executeUpdate("DROP TABLE IF EXISTS cl");
        ...
        for (int i = 0; i <= monthsBetween; i++) {					
            ...
            query = "SELECT COUNT(*) AS count FROM cl WHERE MONTH(time_stamp) = " + month + "  AND YEAR(time_stamp) = " + year; 
