 ...
 * @author user10
 */
public class EacGridAction extends ActionSupport implements Preparable {
    ...
    public String eacGrid() {
        ...
        try {
            ...
            query = "SELECT * FROM eac WHERE facility_id = ? AND patient_id = ? ORDER BY date_eac1 DESC";
