...
public class DeliveryGridAction extends ActionSupport implements Preparable {
    ...
    public String deliveryGrid() {
        ...
        try {
            ...
            query = "SELECT * FROM delivery WHERE facility_id = ? AND patient_id = ?";
