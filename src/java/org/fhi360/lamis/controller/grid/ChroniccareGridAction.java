...
public class ChroniccareGridAction extends ActionSupport implements Preparable {
    ...
    public String chroniccareGrid() {
        ...
        try {
            ...
            query = "SELECT * FROM chroniccare WHERE facility_id = ? AND patient_id = ? ORDER BY date_visit DESC";
